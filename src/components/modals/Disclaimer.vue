<script setup lang="ts">
    ...
    const emit = defineEmits<{
        ...
        (e:'update:checkbox', value:boolean): boolean,
    }>()
    ...
    <Modal v-model="model">
        <div class="pt-10 full-height column no-wrap">
            ...
            <div class="bg-white-5 rounded-10 relative-position q-mb-22 overflow-auto max-h-360 grow-1">
                ...
                <div class="sticky-bottom rounded-10 text-overlay-gradient h-100 z-1">

                </div>
            </div>
            <div>
                <q-checkbox v-model="checkboxModel" label="I understand the risks and would like to proceed." class="fs-12 font-weight-regular q-mb-40"/>
            </div>
            <div class="flex justify-center">
                <StandardButton class="q-px-50 q-py-15">
                    <div class="flex">
